...
void Pantalla_Inicio (tFuente *fuente, int *juego)
{
    ...
    *juego = 2;
    ...
    while(*juego == 2)
    {
        ...
        fuente_dibujar_texto(220, 50, "TETRIS - LUMINOSOS", 7, 2, fuente);
...
void Pausar_Juego (tFuente *fuente, int *juego)
{
    ...
    while (en_pausa)
    {
        ...
        fuente_dibujar_texto(260, 180, "JUEGO EN PAUSA", 7, 1, fuente); // Blanco (7)
        ...
        int color_opcion2 = (seleccion == 2) ? 7 : 8;
        fuente_dibujar_texto(220, 280, "ESC - VOLVER AL MENU", color_opcion2, 1, fuente);
